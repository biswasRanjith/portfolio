...
export default function Project({
  ...
  return (
    ...
    >
      <section className="bg-gray-120 max-w-[58rem] border border-black/5 rounded-lg overflow-hidden sm:pr-8 relative lg:min-h-[21rem] hover:bg-gray-200 transition dark:text-white dark:bg-white/10 dark:hover:bg-white/20">
        <div className="pt-4 pb-7 px-5 md:pl-10 md:pr-2 md:pt-10 lg:max-w-[50%] flex flex-col h-full">
          ...
          <div className="flex">
            {urlLink && (
              ...
              >
                <BiLinkExternal className="mr-1" /> Details
              </a>
            )}
